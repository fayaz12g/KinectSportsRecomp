...
__attribute__((alias("__imp__sub_823C02B8"))) PPC_WEAK_FUNC(sub_823C02B8);
PPC_FUNC_IMPL(__imp__sub_823C02B8) {
	PPC_FUNC_PROLOGUE();
	uint32_t ea{};
	// mflr r12
	ctx.r12.u64 = ctx.lr;
...
loc_823C0304:
	...
	// bl 0x823c0758
	ctx.lr = 0x823C0310;
	sub_823C0758(ctx, base);
	// lbz r11,84(r1)
	ctx.r11.u64 = PPC_LOAD_U8(ctx.r1.u32 + 84);
	// cmplwi r11,0
	ctx.cr0.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// bne 0x823c0324
	if (!ctx.cr0.eq) goto loc_823C0324;
	// li r27,4
	ctx.r27.s64 = 4;
	// b 0x823c03bc
	goto loc_823C03BC;
loc_823C0324:
	...
	// beq cr6,0x823c0374
	if (ctx.cr6.eq) goto loc_823C0374;
	// b 0x823c036c
	goto loc_823C036C;
loc_823C0344:
	// lwz r11,0(r31)
	...
	// bl 0x823c05c8
	ctx.lr = 0x823C035C;
	sub_823C05C8(ctx, base);
	// clrlwi r11,r3,16
	ctx.r11.u64 = ctx.r3.u32 & 0xFFFF;
	// cmplwi cr6,r11,65535
	ctx.cr6.compare<uint32_t>(ctx.r11.u32, 65535, ctx.xer);
	// beq cr6,0x823c03a4
	if (ctx.cr6.eq) goto loc_823C03A4;
	// addi r28,r28,-1
...
loc_823C036C:
	...
	// bgt cr6,0x823c0344
	if (ctx.cr6.gt) goto loc_823C0344;
loc_823C0374:
	// lwz r11,0(r31)
	ctx.r11.u64 = PPC_LOAD_U32(ctx.r31.u32 + 0);
	// mr r5,r30
	...
	// beq cr6,0x823c0430
	if (ctx.cr6.eq) goto loc_823C0430;
loc_823C03A4:
	// li r27,4
	ctx.r27.s64 = 4;
loc_823C03A8:
...
loc_823C03BC:
	...
	// bne cr6,0x823c03e8
	if (!ctx.cr6.eq) goto loc_823C03E8;
	// ori r11,r11,4
...
loc_823C0430:
	...
	ctx.cr6.compare<int64_t>(ctx.r28.s64, 0, ctx.xer);
	// bgt cr6,0x823c0408
	if (ctx.cr6.gt) goto loc_823C0408;
	// b 0x823c03a8
	goto loc_823C03A8;
}
