...
__attribute__((alias("__imp__sub_82325A9C"))) PPC_WEAK_FUNC(sub_82325A9C);
PPC_FUNC_IMPL(__imp__sub_82325A9C) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
...
__attribute__((alias("__imp__sub_82332ABC"))) PPC_WEAK_FUNC(sub_82332ABC);
PPC_FUNC_IMPL(__imp__sub_82332ABC) {
	PPC_FUNC_PROLOGUE();
	// .long 0x0
}
