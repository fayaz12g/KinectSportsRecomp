...
__attribute__((alias("__imp__sub_824120C0"))) PPC_WEAK_FUNC(sub_824120C0);
PPC_FUNC_IMPL(__imp__sub_824120C0) {
	PPC_FUNC_PROLOGUE();
	PPCRegister temp{};
	uint32_t ea{};
	// mflr r12
	...
	// beq cr6,0x82412100
	if (ctx.cr6.eq) goto loc_82412100;
	// lwz r11,0(r3)
...
loc_82412100:
	...
	// beq cr6,0x8241212c
	if (ctx.cr6.eq) goto loc_8241212C;
	// addi r3,r11,-104
	ctx.r3.s64 = ctx.r11.s64 + -104;
	// bl 0x828c10d0
	ctx.lr = 0x82412120;
	sub_828C10D0(ctx, base);
	// addi r3,r31,4
...
loc_8241212C:
	...
	// beq cr6,0x82412170
	if (ctx.cr6.eq) goto loc_82412170;
	// lwz r28,176(r31)
	ctx.r28.u64 = PPC_LOAD_U32(ctx.r31.u32 + 176);
	// cmplw cr6,r30,r28
	ctx.cr6.compare<uint32_t>(ctx.r30.u32, ctx.r28.u32, ctx.xer);
	// beq cr6,0x82412168
	if (ctx.cr6.eq) goto loc_82412168;
	// addi r29,r30,12
...
loc_82412148:
	...
	ctx.cr6.compare<uint32_t>(ctx.r3.u32, 0, ctx.xer);
	// beq cr6,0x82412158
	if (ctx.cr6.eq) goto loc_82412158;
	// bl 0x82241d18
	ctx.lr = 0x82412158;
...
loc_824121A8:
	...
	// beq cr6,0x824121c8
	if (ctx.cr6.eq) goto loc_824121C8;
	// bl 0x82241d18
	ctx.lr = 0x824121C8;
	sub_82241D18(ctx, base);
loc_824121C8:
...
loc_824121D8:
	...
	// beq 0x824121a8
	if (ctx.cr0.eq) goto loc_824121A8;
	// lwz r11,4(r30)
...
loc_82412264:
	...
	ctx.cr0.compare<uint32_t>(ctx.r11.u32, 0, ctx.xer);
	// beq 0x82412230
	if (ctx.cr0.eq) goto loc_82412230;
	// lwz r11,4(r29)
...
loc_824122B0:
	...
	// bne cr6,0x824122d4
	if (!ctx.cr6.eq) goto loc_824122D4;
	// stwcx. r8,0,r11
	ctx.cr0.lt = 0;
	ctx.cr0.gt = 0;
	...
	// bne 0x824122b0
	if (!ctx.cr0.eq) goto loc_824122B0;
	// b 0x824122dc
	goto loc_824122DC;
loc_824122D4:
	// stwcx. r10,0,r11
...
loc_824122DC:
	...
	// bne cr6,0x824122ac
	if (!ctx.cr6.eq) goto loc_824122AC;
	// lwsync 
	// lwz r10,4(r31)
